...
Openmaps.fr is a free [Tile Map Service](https://wiki.openstreetmap.org/wiki/TMS) based on [OpenStreetMap](https://wiki.openstreetmap.org/) datas providing 2 maps :
...
and
* [OpenHikingMap](https://wiki.openstreetmap.org/wiki/OpenHikingMap) Another map for hiking.


All styles and code are free and OpenSource (Check each one's specific license)
...
## Status of the openmaps.fr service
